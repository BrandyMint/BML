# Абстрактный класс для экспорта данных в CVS.
# Для использования наследуйтесь и переопределите методы:
#
# header_row - отдаст массив с названиями колонов для заголовка
# row(item) - отдает массив строки с полями в порядке указанном в header_row
