module CircleButtonsHelper
  ...
  # Circle Buttons
  def show_button_circle(url, icon: :desktop, title: I18n.t('shared.show'))
    link_to smart_polymorphic_url(url), class: 'btn btn-secondary btn-circle', tooltip: true, title: title do
      fa_icon icon
    end
  end
