...
set :linked_files, %w(config/database.yml config/secrets.yml config/chewy.yml)
set :linked_dirs, %w(log tmp/pids tmp/cache tmp/sockets vendor/bundle public/system public/assets public/uploads public/yandex.market public/l)
